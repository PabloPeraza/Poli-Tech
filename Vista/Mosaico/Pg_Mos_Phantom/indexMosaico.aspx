			...
			<div id="wrapper">
				...
				<!-- Menu -->
					<nav id="menu">
						<h2>Menu</h2>
						<ul>
							<li><a href="/Vista/Main/Pg_Main_Eterna/Eterna/indexMain.aspx">Patrones</a></li>
							<li><a href="/Vista/Mosaico/Pg_Mos_Phantom/indexMosaico.aspx">Home</a></li>
							<li><a href="/Vista/Mosaico/Pg_Mos_Phantom/log-inMosaico.aspx">Administrador</a></li>
				...
				<!-- Main -->
					<div id="main">
							...
							<section class="tiles">
								...
								<article class="style1">
									...
									<a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
										<h2>Procesador Intel® Core™ i5-10500</h2>
										<div class="content">
								...
								<article class="style4">
									...
									<a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
										...
										<div class="content">
											<p>Velocidad de giro de alto rendimiento a 7200 RPM, hasta 32 MB de caché e interfaz SATA 6Gb/s para lo último en potencia informática para portátiles.</p>
										</div>
									</a>
								</article>
								<!--------------------------Gabinete-------------------------------------->
						...
						<ul class="icons">
							<li><a href="#" class="icon brands style2 bi-arrow-90deg-up" ><span class="label">Regresar</span></a></li>
						</ul>
					</div>
