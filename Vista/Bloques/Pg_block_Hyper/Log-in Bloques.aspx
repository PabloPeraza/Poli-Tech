<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Log-in Bloques.aspx.vb" Inherits="Politech.Long_in_Bloques" %>
	...
	<body class="is-preload">
		...
		<!-- Header -->
			<header id="header">
				...
				<nav>
					<ul>
						<li><a href="/Vista/Bloques/Pg_block_Hyper/IndexBloques.aspx">Home</a></li>
						<li><a href="/Vista/Bloques/Pg_block_Hyper/MasInfo.aspx">Informacion</a></li>
