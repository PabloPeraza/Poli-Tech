            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/Vista/Pantalla_Dividida/Pg_PDiv_Agency/startbootstrap-agency-gh-pages/log-in.aspx">Log-in</a></li>
                        <li class="nav-item"><a class="nav-link" href="#contact">Contacto</a></li>
                        <li class="nav-item"><a  class ="nav-link"href="/Vista/Main/Pg_Main_Eterna/Eterna/indexMain.aspx">Patrones</a></li>    
                    </ul>
                </div>
            </div>
        </nav>
